...
public class mod_Zombeefex extends BaseMod
{
    ...
    {
        // ゾンビ肉のアイテムID
        int rottenFleshIcon = 91;
        // 基本
        itemZombeefex = new ItemZombeefex(itemZombeefexID, -19, ItemIDZombeefEx, 0x228b22).setItemName("itemZombeefex").setIconIndex(rottenFleshIcon);
        // 猛毒
        itemZombeefexPoison = new ItemZombeefex(itemZombeefexPoisonID, -19, ItemIDZombeefExPoison, 0x0000ff, intPotionEffectSecond, intPotionEffectAmplifier).setItemName("itemZombeefexPoison")
        .setIconIndex(rottenFleshIcon);
        // 盲目
        itemZombeefexBlind = new ItemZombeefex(itemZombeefexBlindID, -19, itemIDZombeefExBlind, 0x000000, intPotionEffectSecond, intPotionEffectAmplifier).setItemName("itemZombeefexBlind")
        .setIconIndex(rottenFleshIcon);
        // 鈍足
        itemZombeefexSlow = new ItemZombeefex(itemZombeefexSlowID, -19, itemIDZombeefExSlow, 0x00ff00, intPotionEffectSecond, intPotionEffectAmplifier).setItemName("itemZombeefexSlow").setIconIndex(
                rottenFleshIcon);
        // 混乱
        itemZombeefexConf = new ItemZombeefex(itemZombeefexConfID, -19, itemIDZombeefExConf, 0x00ffff, intPotionEffectSecond, intPotionEffectAmplifier).setItemName("itemZombeefexConf").setIconIndex(
                rottenFleshIcon);
        // 弱体
        itemZombeefexWeak = new ItemZombeefex(itemZombeefexWeakID, -19, itemIDZombeefExWeak, 0x808080, intPotionEffectSecond, intPotionEffectAmplifier).setItemName("itemZombeefexWeak").setIconIndex(
                rottenFleshIcon);
        // 耐火
        itemZombeefexFire = new ItemZombeefex(itemZombeefexFireID, -19, itemIDZombeefExFire, 0xff0000, intPotionEffectSecond, intPotionEffectAmplifier).setItemName("itemZombeefexFire").setIconIndex(
                rottenFleshIcon);
        // 障害
        itemZombeefexHarm = new ItemZombeefex(itemZombeefexHarmID, -19, itemIDZombeefExHarm, 0xff00ff).setItemName("itemZombeefexHarm").setIconIndex(rottenFleshIcon);
        // 鈍堀
        itemZombeefexDigSlow = new ItemZombeefex(itemZombeefexDigSlowID, -19, itemIDZombeefExDigSlow, 0xff8000, intPotionEffectSecond, intPotionEffectAmplifier).setItemName("itemZombeefexDigSlow")
        .setIconIndex(rottenFleshIcon);
        // 空腹
        itemZombeefexHunger = new ItemZombeefex(itemZombeefexHungerID, -19, itemIDZombeefExHunger, 0xffff00, intPotionEffectSecond, intPotionEffectAmplifier).setItemName("itemZombeefexHunger")
        .setIconIndex(rottenFleshIcon);
        // 全部
        itemZombeefexSuper = new ItemZombeefex(itemZombeefexSuperID, 20, itemIDZombeefExSuper, 0xffffff, intPotionEffectSecond, intPotionEffectAmplifier).setItemName("itemZombeefexSuper")
        .setIconIndex(rottenFleshIcon);
        // 餓鬼道
        BuddhistPurgatoryOfHunger = new ItemZombeefex(BuddhistPurgatoryOfHungerID, 20, ItemIDBuddhistPurgatoryOfHunger, 0x8000ff).setItemName("BuddhistPurgatoryOfHunger")
        .setIconIndex(rottenFleshIcon);
        // 夜目
        itemZombeefexNightVision = new ItemZombeefex(itemZombeefexNightVisionID, -19, itemIDZombeefExNightVision, 0x00ff80, intPotionEffectSecond, intPotionEffectAmplifier).setItemName(
                "itemZombeefexNightVision").setIconIndex(rottenFleshIcon);
        // 透明
        itemZombeefexInvisibility = new ItemZombeefex(itemZombeefexInvisibilityID, -19, itemIDZombeefExInvisibility, 0x80ff00, intPotionEffectSecond, intPotionEffectAmplifier).setItemName(
                "itemZombeefexInvisibility").setIconIndex(rottenFleshIcon);
        // 水中呼吸
        itemZombeefexWaterBreathing = new ItemZombeefex(itemZombeefexWaterBreathingID, -19, itemIDZombeefexWaterBreathing, 0xff0080, intPotionEffectSecond, intPotionEffectAmplifier).setItemName(
                "itemZombeefexWaterBreathing").setIconIndex(rottenFleshIcon);
        // Wither
        itemZombeefexWither = new ItemZombeefex(itemZombeefexWitherID, -19, itemIDZombeefexWither, 0x0080ff, intPotionEffectSecond, intPotionEffectAmplifier).setItemName("itemZombeefexWither")
        .setIconIndex(rottenFleshIcon);
        // 名前
    ...
    // TODO ダメージ値にしたほうが明らかに楽なのでそのうちなおす
